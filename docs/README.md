...
│   ├── MED24.md                 — API med24 (справочник клиник/врачей «Здоровья»)
│   ├── WHOOP.md                 — интеграция WHOOP (данные, OAuth, вебхуки)
│   ├── WHOOP_PAGES_PLAN.md      — план экранов показателей WHOOP (RU/UZ, Liquid Glass)
│   ├── WHOOP.md                 — интеграция носимого трекера WHOOP в модуль «Здоровье»: данные, вебхуки, план
│   ├── WHOOP_BRIEF.md           — WHOOP: управленческая записка + детальные вопросы к руководству
│   └── WHOOP_SETUP.md           — WHOOP: пошаговая инструкция получения ключей + настройки приложения
│
