...
>
> **Последнее обновление:** 2026-06-21 — модуль поддержки (realtime-чат), модуль партнёров (M16), проверка полиса по QR, управление пользователями, ПРОД задеплоен, TestFlight залит и проверен
