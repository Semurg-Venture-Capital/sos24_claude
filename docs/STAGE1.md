...
>
> **Последнее обновление:** 2026-06-24 — **B2B-кабинет партнёров `partner.sos24.uz`** (страховые + сервис-партнёры) задеплоен в прод; до этого (06-21) — поддержка, партнёры (M16), QR-проверка, управление пользователями, TestFlight build 5
