...
>
> **Последнее обновление:** 2026-07-11 — **med24: клиники + врачи** (пробно 9 клиник + 127 врачей в «Здоровье», описание/часы на странице клиники); справочник API → `docs/integrations/MED24.md`; фильтр-чипы на **нативном iOS 26 Liquid Glass** (капля-морфинг — план на завтра). Ранее сегодня: починен вход (истёкший provisioning dev-client) + переустановлен билд. До этого (07-10) — голос в европротоколе + блокер по ключу Gemini.
