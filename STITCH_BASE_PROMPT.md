...
| 2 | M4 Каталог + M5 Калькулятор тарифа (10 экранов) | discovery + pricing |
| 3 | M6 Оформление полиса + M7 Платежи (10 экранов) | checkout-флоу |
| 4 | M8 Мои полисы + M3 Гараж + M14 Главный (10 экранов) | основное использование |
| 5 | M9 ДТП + M9.1 Комиссар + M10 Выплаты (12 экранов) | критический флоу — финальная полировка |
| 6 | M2 Профиль + M11 Уведомления + M12 Документы + M13 Поддержка (12 экранов) | вспомогательное |
| 7 | Web Landing (10 секций) | маркетинг |
| 8 | Web Admin (12 экранов) | внутренний |
| 9 | Web Partner Cabinet (10 экранов) | B2B |
...
| 2026-05-06 | Уточнён порядок батчей: M5 = калькулятор, M6 = оформление полиса (раньше было склеено) | Claude |
