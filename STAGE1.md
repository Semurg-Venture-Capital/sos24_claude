...
**Последние завершённые задачи:** S10 Финансы + фиксы (pull-to-refresh полисов, useFocusEffect, сборка на реальное устройство). Тестирование на iPhone 13 Pro Max — приложение работает.
...
### S11 — Оффлайн + Apple/Google Wallet ← ОБСУЖДЕНО, НЕ НАЧАТО
...
### S12 — Европротокол ← СЛЕДУЮЩИЙ КРУПНЫЙ (нужен дизайн + решение по варианту)
